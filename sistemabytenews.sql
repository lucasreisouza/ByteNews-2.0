...
--
-- Host: localhost:3307
-- Tempo de geração: 11-Set-2026 às 22:06
...
--
-- Extraindo dados da tabela `curtidas_noticias`
--

INSERT INTO `curtidas_noticias` (`id_usuario`, `id_noticia`, `data_curtida`) VALUES
(7, 9, '2026-09-10 21:19:19'),
(7, 15, '2026-09-10 21:19:27');
...
CREATE TABLE `noticias` (
  ...
  `fonte_nome` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fonte_url` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `solicitacoes_moderador` (
  ...
  `id_admin_decisor` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `usuarios` (
  ...
  `senha_segura` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo_usuario` enum('admin','editor','leitor') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'leitor',
  `data_criacao` datetime DEFAULT CURRENT_TIMESTAMP,
  `pergunta_seguranca` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `resposta_seguranca` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `comentarios`
  MODIFY `id_comentario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de tabela `curtidas_comentarios`
--
ALTER TABLE `curtidas_comentarios`
  MODIFY `id_curtida` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de tabela `noticias`
--
ALTER TABLE `noticias`
  MODIFY `id_noticia` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de tabela `solicitacoes_moderador`
--
ALTER TABLE `solicitacoes_moderador`
  MODIFY `id_solicitacao` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

...
const logoHeaderNews = document.querySelector('#logoHeaderNews');
...
function toggleStyle() {
  if (body.classList.contains('dark')) {
    ...
    logoHeaderNews.src = './src/assets/icons/logo-claro.png';
    ...
    logoHeaderNews.src = './src/assets/icons/logo-padrao.png';

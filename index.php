...
<body class="dark">
    ...
    <main>
        <div class="container">
            <!-- ================= CARROSSEL PRINCIPAL ================= -->
            <section id="Home" class="carousel-main"> <!-- carrossel principal-->
                <!-- Carrossel Bootstrap -->
                        ...
                        <div class="carousel-item active">
                            <div class="cartao noticia1">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    <h5>GTA 6: lançamento, trailer e o que esperar do jogo</h5>
                                </div>
                            </div>
                        </div>
                        <!-- Slide 2 -->
            ...
            <!-- ================= DESTAQUES DO DIA ================= -->
            <section id="Destaques" class="news-emphasis">
                <!-- Título da seção -->
                ...
                <div class="news-emphasis_cards">
                        ...
                        <a target="_blank" href="./src/pages/news/grecia-redes-sociais.php">
                            ...
                            <figure class="news-card_image">
                                <img src="./src/assets/images/news-emphasis/grecias-redes-sociais.png"
                                    alt="Grécia proibirá redes sociais para menores de 15 anos a partir de 2027">
                            </figure>
                            <!-- Conteúdo da notícia -->
                            <div class="news-card_content">
                                ...
                                <p class="news-card_time">🕐 2 horas atrás</p>
                            </div>
                        </a>
                    </article>
                    <article class="news-card">
                        <a target="_blank" href="./src/pages/news/hacker-reino-unido.php">
                            ...
                            <figure class="news-card_image">
                                <img src="./src/assets/images/news-emphasis/hackers-reino-unido.png"
                                    alt="Imagem ilustrativa do hacker no Reino Unido">
                            </figure>
                            <!-- Conteúdo da notícia -->
                            <div class="news-card_content">
                                ...
                                <p class="news-card_time">🕐 4 horas atrás</p>
                            </div>
                        </a>
                    </article>
                    <article class="news-card">
                        <a target="_blank" href="./src/pages/news/modelo-ia.php">
                            ...
                            <figure class="news-card_image">
                                <img src="./src/assets/images/news-emphasis/modelo-ia.png"
                                    alt="Imagem ilustrativa do modelo de IA">
                            </figure>
                            <!-- Conteúdo da notícia -->
                            <div class="news-card_content">
                                ...
                                <p class="news-card_time">🕐 6 horas atrás</p>
                            </div>
                        </a>
                    </article>
                    <article class="news-card">
                        <a target="_blank" href="./src/pages/news/voz-clonada.php">
                            ...
                            <figure class="news-card_image">
                                <img src="./src/assets/images/news-emphasis/voz-clonada.png"
                                    alt="Imagem ilustrativa da voz clonada">
                            </figure>
                            <!-- Conteúdo da notícia -->
                            <div class="news-card_content">
                                <span class="news-card_category ia">IA</span>
                    ...
                    <!-- outros articles repetem o mesmo padrão -->
                </div>
            </section>
            <!-- ================= ÁREA INFERIOR ================= -->
            <div class="news-lower">
                <!-- ===== ÚLTIMAS NOTÍCIAS ===== -->
                <section id="Ultimas" class="news-latest">
                    <!-- título -->
                    <div class="news-latest_title">
                            ...
                            <a href="./src/pages/news/ameaca-ia.php" target="_blank">
                                ...
                                <div class="news-latest_content">
                                    ...
                                    <div class="news-card_description">
                                        <!-- visualizações -->
                                        <img class="icon-eye" src="./src/assets/icons/eye.png" alt="olho">
                                        <p>2.3k</p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <article>
                            <a href="./src/pages/news/guerra-eua.php" target="_blank">
                                ...
                                <div class="news-latest_content">
                                    <!-- título -->
                                    <h2 class="news-card_title">
                                        EUA usam IA como tecnologia de guerra
                                    </h2>
                                    <div class="news-card_description">
                                        <!-- visualizações -->
                                        <img class="icon-eye" src="./src/assets/icons/eye.png" alt="olho">
                ...
                <!-- ===== NOTÍCIAS EM ALTA ===== -->
                <section id="EmAlta" class="news-rise">
                    <!-- título -->
                    ...
                    <ol class="news-rise_list">
                        <li class="news-rise_item">
                            <a href="./src/pages/news/gta-6.php" target="_blank">
                                ...
                                <div class="news-rise_content">
                                    ...
                                    <div class="news-rise_stats">
                                        <span class="news-rise_trend up">↑ 50.2k</span>
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="news-rise_item">
                            <a href="./src/pages/news/carro-voador.php" target="_blank">
                                ...
                                <div class="news-rise_content">
                                    ...
                                    <div class="news-rise_stats">
                                        <span class="news-rise_trend up">↑ 38.7k</span>
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="news-rise_item">
                            <a href="./src/pages/news/hacker-reino-unido.php" target="_blank">
                                ...
                                <div class="news-rise_content">
                                    ...
                                    <div class="news-rise_stats">
                                        <span class="news-rise_trend up">↑ 29.1k</span>
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        <!-- repita o padrão pros demais itens -->
                    </ol>
                </section>
            </div>
        </div>
        ...
        <div class="box-footer">
            <div class="first-footer">
                ...
                <div class="logo-footer">
                    <img id="logoFooter" src="./src/assets/icons/logo-padrao.png" alt="Logo ByteNews">
                </div>
                <!-- frase do footer -->
                <div class="phrase">
                ...
                <div class="social-media"><!-- redes sociais-->
                    <a href="#nav"><img src="./src/assets/icons/instagram.png" alt="Instagram"></a>
                    <a href="#nav"><img src="./src/assets/icons/whatsapp.png" alt="Whatsapp"></a>
                    <a href="#nav"><img src="./src/assets/icons/facebook.png" alt="Facebook"></a>
                    <a href="#nav"><img src="./src/assets/icons/tiktok.png" alt="Tiktok"></a>
                </div>
            </div>
            <!-- caixa de navegação -->
